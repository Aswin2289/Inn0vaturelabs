 ...
 */
package com.innovature.HotelManagement.configuration;

import com.innovature.HotelManagement.security.AccessTokenProcessingFilter;
import com.innovature.HotelManagement.security.AccessTokenUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .securityContext().and()
                .anonymous().and()
                .authorizeRequests()                .antMatchers(OPTIONS, "/users").anonymous()
