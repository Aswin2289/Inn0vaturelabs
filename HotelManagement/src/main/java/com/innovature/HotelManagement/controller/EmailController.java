...
import com.innovature.HotelManagement.form.EmailForm;
...
import com.innovature.HotelManagement.service.EmailService;
...
public class EmailController {
    ...
    public ResponseEntity<?>sendEmail(@RequestBody EmailForm form){
        ...
        boolean result = this.emailService.sendEmail("Nan dhaa shandhappan","Eda njn email set akki", form.getSentto());
    ...
    public ResponseEntity<?>sendConfirm(@RequestParam Integer bookId,@RequestParam String email){
      
        boolean result = this.bookingService.sendBookEmail(bookId,email);
    ...
    @PostMapping("/Cancelbookingemail")
    public ResponseEntity<?>sendCanelConfirm(@RequestParam Integer bookId,@RequestParam String email){
      
        boolean result = this.bookingService.sendCancelBookEmail(bookId,email);
